...
const RecipeDetails = () => {
    ...
    return (
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
            {/* left content */}
            <div>
                <img src={RecipeDetails.image} className="w-full h-[500px] md:h-[650px]  object-cover rounded-2xl">
                </img>
            </div>
            ...
            <div className=" mt-4">
              <div >
                 <h2 className=" text-md md:text-lg font-bold text-red-600 mb-2">{RecipeDetails.foodName}</h2>
                <h1 className=" text-2xl md:text-4xl font-bold mb-8">{RecipeDetails.title}</h1>
                  <div className="flex flex-wrap gap-4 md:gap-12 mt-1 items-center text-gray-500 mb-8">
                    ...
                    <div className=" pt-8">
                          ...
                          <ul className=" list-disc list-inside mt-4">
                                  ...
                                  {RecipeDetails.details.ingredients.map((item,index)=>(
                                    <li className=" text-lg font-bold" key={index} >{item}</li>
                                  ))}
                     ...
                     {/* button */}
                       <button 
                     className="bg-emerald-600 hover:bg-emerald-700 rounded-lg text-black font-semibold mt-6 px-5 py-2 ">
                                 Add to Favorite
                           </button>
