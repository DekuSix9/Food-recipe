...
const Banner = () => {
  return (
    <div className="px-3 sm:px-4 md:px-6 py-3">
      <div
        className="  h-[380px] sm:h-[450px] md:h-[600px] lg:h-[700px] w-full rounded-2xl bg-cover bg-center flex items-center text-white  shadow-md"
        style={{ backgroundImage: `url(${BannerImg})` }} >
        {/* Content */}
        <div className="px-4 sm:px-8 lg:px-16 max-w-xl sm:max-w-2xl">
