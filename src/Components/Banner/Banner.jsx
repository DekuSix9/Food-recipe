...
const Banner = () => {
  return (
   <div className='px-3 py-2'>
      ...
      <p className=' mt-2 md:mt-4 text-black'>Don't just dream it — discover the perfect recipe that turns your  craving into a masterpiece.</p>
      <div className=' relative'>
     <LuCookingPot className=' h-8 w-8 absolute left-3 top-13 text-emerald-700'></LuCookingPot>

     <input
  type="text"
  placeholder="Find what you want to cook today"
  className="w-full md:w-full bg-white mt-6  md:mt-10  rounded-2xl px-14 py-5 text-black placeholder-gray-600   ">
